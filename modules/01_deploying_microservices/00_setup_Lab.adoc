...
The OpenShift environment currently has other accounts that we are not using. We'll remove them now.
...
* You should see:
+
image::images/openshift-web-console-projcets.png[OpenShift Web Projects]
