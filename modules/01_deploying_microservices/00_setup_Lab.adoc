...
+
-----
oc delete all --all -n user1-coolstore-catalog
oc delete project user1-coolstore-catalog

oc delete all --all -n user1-coolstore-gateway
oc delete project user1-coolstore-gateway
-----
...
Lab environments are available in _Red Hat Partner Demo System_ (RHPDS).
