...
* Terminal 2: Generating requests with the our script

image::images/two-terminals.png[]
...
* Confirm that half of the requests above go to `catalog-v1` and the other half to `catalog-v2`.

image::images/v1-50-and-v2-50.png[]
...
image::images/v1-and-v2-2pods.png[]
...
. View the Kiala web console and confirm that the requests are split evenly between `v1` and `v2`.
...
. View the Kiala web console and confirm that all requests are being routed to
`catalog:v2`.

image::images/v2-100.png[]
...
* View the Kiala web console and confirm that traffic is equally split once again between `v1` and `v2`.
...
. View the Kiala web console. Overtime you will see approximately 70% going to `v1`. You should see approximately 30% going to `v2`. This process can be continued (and automated), slowly migrating
...
image::images/v1-70-and-v2-30.png[]
...
. View the Kiala web console and confirm the traffic results: 40% to v1 and 60% to v2.
+
image::images/v1-40-and-v2-60.png[]
...
. View the Kiala web console and confirm the traffic results: 10% to v1 and 90% to v2.
+
image::images/v1-10-and-v2-90.png[]
...
. View the Kiala web console and confirm the traffic results: 100% to v2.
+
image::images/v2-100.png[]
