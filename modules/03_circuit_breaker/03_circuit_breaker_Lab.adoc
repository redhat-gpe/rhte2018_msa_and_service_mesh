...
In this lab you learned how to implement the pool ejection resilience strategy to increase the overall availability. You also leverage the circuit breaker pattern to avoid multiple concurrent requests to a failed instance.
